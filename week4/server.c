    ...
    while (1) {
        ...
        if (FD_ISSET(master_sock_tcp_fd, &readfds)) {
            ...
            while (1) {
                ...
                char name_age_group[100];
                strcpy(name_age_group, "(");
                strcat(name_age_group, client_data->name);
                strcat(name_age_group, ", ");
                strcat(name_age_group, client_data->age);
                strcat(name_age_group, ", ");
                strcat(name_age_group, client_data->group);
                strcat(name_age_group, ")");
                strcpy(result.name_age_group, name_age_group);
